...
import data from "../services/features.json";

const Features = () => {
  const description = "Smart AI resumes, built in minutes.";
  const title = "Create Resumes in Minutes";
  return (
    <section className="py-12 space-y-6">
      ...
      {/* Call to Action */}
     <CTA title={title} description={description} />
    </section>
  );
};
